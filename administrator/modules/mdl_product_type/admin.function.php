...
?>
				<tr class="<?php echo ($parent_id == 0) ? 'bg-gray-light' : ''; ?> valign-middle">
					...
					<td>
						<select class="form-control" name="position" id="position" onchange="update_value_by_id('<?php echo $table ?>', 'position', '<?php echo $product_type->id ?>', this.value);">
							<option value="">Chọn vị trí</option>
							<option value="header" <?php echo ($product_type->position == 'header') ? 'selected="selected"' : '' ?>>Đầu trang</option>
							<option value="home" <?php echo ($product_type->position == 'home') ? 'selected="selected"' : '' ?>>Trang chủ</option>
							<option value="left" <?php echo ($product_type->position == 'left') ? 'selected="selected"' : '' ?>>Menu trái</option>
							<option value="right" <?php echo ($product_type->position == 'right') ? 'selected="selected"' : '' ?>>Menu phải</option>
							<option value="footer" <?php echo ($product_type->position == 'footer') ? 'selected="selected"' : '' ?>>Cuối trang</option>
						</select>
					</td>
					<td>
