...
?>
		<section class="content-header">
			<h1>
				...
				<a class="col-lg-1 col-md-2 col-sm-2 col-xs-12 btn btn-success pull-right" href="javascript:void(0);" data-toggle="modal" data-target="#showCNTT" onclick="showCNTT('','ajax/review/ajax.web_image_add.php');">
					Thêm mới
				</a>
			</h1>
		</section>
