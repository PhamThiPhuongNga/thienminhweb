...
<div class="modal-dialog modal-wide">
	<form method="POST" action="?module=product_category&task=product_category_add" name="product_category_add" id="product_category_add" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-4 col-md-4 col-lg-4">
									<select name="parent" id="parent" class="form-control">
										...
										<?= $ariacms->printMenuOption('e4_term_taxonomy', 'id', 'title_vi', '', '', '', 'product_category'); ?>
									</select>
								</div>
			...
			<div class="modal-footer">
				<div class="form-group">
					<div class="col-md-12 text-center">
						<button type="submit" class="btn btn-primary" name="submit" value="product_category_add">Cập nhật</button>
