...
<div class="modal-dialog modal-wide">
	<form method="POST" action="?module=news_group&task=news_group_add" name="news_group_add" id="news_group_add" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-4 col-md-4 col-lg-4">
									<select name="parent" id="parent" class="form-control">
										...
										<?= $ariacms->printMenuOption('e4_term_taxonomy', 'id', 'title_vi', '', '', '', 'group'); ?>
									</select>
								</div>
			...
			<div class="modal-footer">
				<div class="form-group">
					<div class="col-md-12 text-center">
						<button type="submit" class="btn btn-primary" name="submit" value="news_group_add">Cập nhật</button>
