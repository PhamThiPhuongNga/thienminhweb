...
<div class="modal-dialog modal-wide">
	<form method="POST" action="?module=news_type&task=news_type_add" name="news_type_add" id="news_type_add" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-4 col-md-4 col-lg-4">
									<select name="parent" id="parent" class="form-control">
										...
										<?= $ariacms->printMenuOption('e4_term_taxonomy', 'id', 'title_vi', '', '', '', 'type'); ?>
									</select>
								</div>
			...
			<div class="modal-footer">
				<div class="form-group">
					<div class="col-md-12 text-center">
						<button type="submit" class="btn btn-primary" name="submit" value="news_type_add">Cập nhật</button>
