...
<body>
	<!--<input type="hidden" name="nxtinfo" data-info-order="BNC1626928568" data-info-web="SHOWROOM OTOCHAT"
                            ...
                            <?php  if(!$products) {  ?>
                                ...
                                <div class="content rowNoMargin" style="font-size:16px;">
                                    <span style="font-size:18px;">
                                        Giỏ hàng trống - <a href="/" style="color:#971a36 !important;">Quay về trang chủ</a>
                                    </span>
                                </div>
                        <?php } else { ?>
                            ...
                            <div class="content rowNoMargin" style="font-size:16px;">
                                ...
                                <div class="list-product row rowNoMargin">
                                    <div class="img col-md-3 col-sm-4 col-xs-3">
                                        <a href="<?=$ariacms->actual_link . 'chi-tiet/' . $pro->url_part . '.html'?>"target="_blank" tilte="<?php echo $pro->title_vi ?>">
                                    ...
                                    <div class="product-info col-md-9 col-sm-8 col-xs-9">
                                        <div class="product-name">
                                            <a href="<?=$ariacms->actual_link . 'chi-tiet/' . $pro->url_part . '.html'?>"
    ...
    <script type="text/javascript" src="/templates/otochat/modules/payment/themes/js/loading-overlay.min.js"></script>
    <script type="text/javascript" src="/templates/otochat/modules/payment/themes/js/jquery.fancybox.js">
    </script>
    <script type="text/javascript" src="/templates/otochat/modules/payment/themes/js/icheck.min.js"></script>
