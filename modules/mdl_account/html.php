    ...
    <body class="checkout-cart">
     ...
     <div id="account-login" class="container">
      <ul class="breadcrumb">
        ...
        <li><a href="<?=$ariacms->actual_link?>/account/login.html"><?=_LOGIN?></a></li>
      </ul>
      <div class="row">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="well">
                ...
                <a href="<?=$ariacms->actual_link?>/account/register.html" class="btn btn-primary">Continue</a></div>
              </div>
              <div class="col-sm-6">
                <div class="well">
                  <h2>Returning Customer</h2>
                  <p><strong>I am a returning customer</strong></p>
                  <form action="http://amino.demo2.towerthemes.com/index.php?route=account/login" method="post" enctype="multipart/form-data">
